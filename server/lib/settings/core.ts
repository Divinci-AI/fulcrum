...
export function getSettings(): Settings {
  ...
  const settings: Settings = {
    ...
    integrations: {
      ...
      cloudflareEmailEnabled: (fv('integrations.cloudflareEmailEnabled') as boolean | null) ?? null,
      cloudflareEmailFromAddress: (fv('integrations.cloudflareEmailFromAddress') as string | null) ?? null,
      cloudflareEmailIngestSecret: (fv('integrations.cloudflareEmailIngestSecret') as string | null) ?? null,
  ...
  return {
    ...
    integrations: {
      ...
      cloudflareEmailEnabled: settings.integrations.cloudflareEmailEnabled,
      cloudflareEmailFromAddress: process.env.CLOUDFLARE_EMAIL_FROM ?? settings.integrations.cloudflareEmailFromAddress,
